...
const Hospital = () => {
    ...
    const [allList, setAllList] = useState([
        ...
        },
        {
            ...
            area: "경기",
            name: "안양 태안과",
            address: "경기 안양시 동안구 평촌대로223번길 64 제일상가 305호",
            tel: "031-384-7878",
            link: "http://taeeye.co.kr/index.html",
            mapKey: "2n3jc",
            mapTimestamp: "1739840787024",
        },
        {
            id: 18,
            area: "경기",
        ...
        },
        {
            ...
            area: "경상",
            name: "구미 진안과",
            address: "경북 구미시 구미중앙로 85",
            tel: "054-453-6989",
            link: "",
            mapKey: "2n3jd",
            mapTimestamp: "1739840919788",
        },
        {
            id: 21,
            area: "경기",
            name: "아인병원",
            address: "인천 미추홀구 경인로 372 아인병원",
            tel: "032-247-2000",
        ...
        },
        {
            ...
            name: "JC 빛소망안과",
            address:
                "서울시 영등포구 국제금융로6길 33 맨하탄빌딩 6층(여의도동 36-2)",
            tel: "02-785-1068",
        ...
        },
        {
            ...
            name: "수원퍼스트안과",
            address:
                "경기도 수원시 영통구 덕영대로 1470, 6층 (망포역 플래티넘베이스)",
            tel: "1833-2839",
        ...
        },
        {
            ...
            name: "파주푸른세상안과",
            address:
                "경기도 파주시 청암로17번길 33 (목동동 933) 현대메디칼프라자 6층",
            tel: "031-935-5015",
        ...
        },
        {
            ...
            area: "서울",
            name: "잠실서울밝은안과",
            address: "서울 송파구 송파대로 422 영빌딩 3층",
            tel: "0507-1336-0171",
            link: "https://www.goodlasik.co.kr/index.php",
            mapKey: "2n2ox",
            mapTimestamp: "1739510546041",
        },
    ]);
                ...
                <div className="section_wrap" ref={contRef}>
                    <div className="section_con hospital_section1">
                                    ...
                                    >
                                        <g filter="url(#filter0_d_450_36599)">
                                            <path
                                                ...
                                                map-data="서울"
                                                d="M142.224 174.491L135.63 157L122.86 157.446L116.931 174.045L105.49 173.599L102.181 182.017L89.4237 178.031L87 186.659L96.4732 199.941L108.787 213L126.392 208.581L138.484 209.683L153 189.766L139.8 186.659L142.224 174.491Z"
                                                fill="#E6E8EE"
                                                stroke="white"
                                                strokeWidth="3"
                                            ...
                                            />
                                            <path
                                                className={`area area8${
                                                    areaOnIdx === 8 ? " on" : ""
                                                }`}
                                                map-data="제주"
                                                d="M144.017 766.547L105.847 768.419L87.6928 777.491H71.9487L52.7266 801.249L65.8058 821H79.4239L87.9671 813.525L109.589 814.328L125.598 808.185L145.888 800.72L157.361 781.498L144.017 766.547Z"
                                                fill="#E6E8EE"
                                                stroke="white"
                                                strokeWidth="3"
                                                strokeLinejoin="round"
                                        ...
                                        <defs>
                                            ...
                                            >
                                                ...
                                                <feColorMatrix
                                                    type="matrix"
                                                    values="0 0 0 0 0.847309 0 0 0 0 0.858092 0 0 0 0 0.895833 0 0 0 0.24 0"
                                                />
                                                <feBlend
                                                    mode="normal"
                                                    in2="BackgroundImageFix"
                                                    result="effect1_dropShadow_450_36599"
                                                />
                                                <feBlend
                                                    mode="normal"
                                                    in="SourceGraphic"
                                                    in2="effect1_dropShadow_450_36599"
                                                    result="shape"
                                                />
                                            </filter>
                                        </defs>
                        ...
                        <div className="list_hospital_wrap">
                            <div className="util_wrap">
                                <span>
                                    {areaTxt}{" "}
                                    <b>{CF.MakeIntComma(list.length)}개</b>
                                </span>
                    ...
                    <div className="section_con hospital_section2">
                        <div className="txt_section_con">
                            <strong>
                                지금 <b>지머의 클리어라식과</b> <br />
                                함께 하세요!
                            </strong>
                            <p>
                                지머는 고객에게 새로운 세상을 전달하고, <br />
                                좋은 시너지를 위해 다양한 제휴 문의를 받습니다.
                            </p>
                            <button
                                type="button"
                                className="btn_style2"
                                onClick={() => dispatch(inquirePop(true))}
                            >
                                <span>제휴문의하기</span>
                            </button>
                        </div>
